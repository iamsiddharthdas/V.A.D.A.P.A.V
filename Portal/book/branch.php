...
<div class="row">
<div class="col-md-12">
<h1 class="page-head-line">Student details
<?php
...
<label class="col-sm-2 control-label" for="Old">Registration Number</label>
<div class="col-sm-10">
<input type="text" class="form-control" id="branch" name="branch" value="<?php echo $branch;?>"  />
</div>
</div>
<div class="form-group">
<label class="col-sm-2 control-label" for="Password"> Name </label>
<div class="col-sm-10">
